...
urlpatterns = [
    ...
    url(r'^(ventas)/abonos/crear', abonos, name='abonos_v'),
    url(r'^(ventas)/abonos/$', abonosList, name='abonos_list_v'),
    url(r'^abonos/(?P<pk>\d+)/detalles', AbonoDetail.as_view(), name='abonos_detail'),
